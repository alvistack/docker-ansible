...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/ansible-4.4.svg)](https://hub.docker.com/r/alvistack/ansible-4.4)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/ansible-4.4`](https://hub.docker.com/r/alvistack/ansible-4.4)
      - [`packer/docker-4.4/packer.json`](https://github.com/alvistack/docker-ansible/blob/master/packer/docker-4.4/packer.json)
...
Start Ansible:
    ...
    # Pull latest image
    docker pull alvistack/ansible-4.4
