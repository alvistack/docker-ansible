...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/ansible-5.2.svg)](https://hub.docker.com/r/alvistack/ansible-5.2)
...
Start Ansible:
    ...
    # Pull latest image
    docker pull alvistack/ansible-5.2
