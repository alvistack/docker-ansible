...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/ansible-5.6.svg)](https://hub.docker.com/r/alvistack/ansible-5.6)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/ansible-5.6`](https://hub.docker.com/r/alvistack/ansible-5.6)
      - [`packer/docker-5.6/packer.json`](https://github.com/alvistack/docker-ansible/blob/master/packer/docker-5.6/packer.json)
...
Start Ansible:
    ...
    # Pull latest image
    docker pull alvistack/ansible-5.6
