...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/ansible-6.2.svg)](https://hub.docker.com/r/alvistack/ansible-6.2)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/ansible-6.2`](https://hub.docker.com/r/alvistack/ansible-6.2)
      - [`packer/docker-6.2/packer.json`](https://github.com/alvistack/docker-ansible/blob/master/packer/docker-6.2/packer.json)
...
Start Ansible:
    ...
    # Pull latest image
    docker pull alvistack/ansible-6.2
