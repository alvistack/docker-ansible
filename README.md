...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/ansible-6.3.svg)](https://hub.docker.com/r/alvistack/ansible-6.3)
...
Start Ansible:
    ...
    # Pull latest image
    docker pull alvistack/ansible-6.3
